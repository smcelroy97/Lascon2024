...
m1module::name() const
{
  return std::string("m1module"); // Return name of the module
}

//-------------------------------------------------------------------------------------
void
m1module::init( SLIInterpreter* i )
{
    // register neurons
    nest::kernel().model_manager.register_node_model<adex_gamma_E_ml>("adex_gamma_E_ml");
} // m1module::init()