...
n = nest.Create('adex_gamma_E_ml') -> excitatory neurons

n = nest.Create('adex_gamma_E_ml', params={'a': 0, 'b':0,'DeltaT': 0.5}) -> inhibhitory neurons

#don't forget to put delay after synapse